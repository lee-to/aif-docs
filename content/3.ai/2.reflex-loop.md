...
- [Development Workflow](/essentials/development-workflow) - where `/aif-loop` fits in the overall process
- [Core Skills](/ai/core-skills) - full command reference including `/aif-loop`
- [Configuration](/essentials/configuration) - `.ai-factory/` storage layout
